...
public final class Lexer202320 {
  ...
  public static Object initialize() {
    ...
    $try:try {
      ...
      $line=221;
      keyWords=$cast(ISet.class,$fix(GCollections.asSet("walk","turnto","jump","leap","turn","drop","get","grab","letGo","nop","front","right","left","back","around","north","south","west","east","if","else","while","repeat","times","facing","can","not","defVar","defProc")));
      $line=222;
      ...
      $line=238;
      ((gold.structures.map.GHashTableMap)translation).put("letGo",'s');
      $line=240;
      ...
      $line=246;
      ((gold.structures.map.GHashTableMap)translation).put("times",'x');
      $line=247;
